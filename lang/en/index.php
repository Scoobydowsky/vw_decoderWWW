...
document.getElementById("main_title").innerHTML = "Your Codes";
document.getElementById("skills-description").innerHTML = "Here are your codes with descriptions";
            ...
            <div class="content navigation">
                ...
                <div class="nav-menu">
                    <ul class="nav main-nav">
                        <li><a class="scroll" href="index.php">Start over</a></li>
                        <li><p class="scroll">Add fields:</p></li>
    ...
    <section id="skills-and-possibilities">
         ...
         <div class="content">
              ...
              <div class="tabs animated" data-animation="fadeInLeft" data-animation-delay="300">
                  ...
                  <h2 class="main_title">Enter the codes</h2>
                  ...
                  <div class="tab-content">
                       ...
                       <div class="tab-pane fade in active" id="first">
                          ...
                          <div id="containerINPUT">
                              ...
                              <!-- Koniec pętli-->
                              <input type="button" value="Check" onclick="loadData()">
                              <input type="reset" value="Reset">
                              <p>
                                Cookies are stored in order to check the codes
                                (after clicking on the button, check which ones delete after closing the browser),
                                if you don't agree <br/>
                                CLOSE THIS PAGE <br/>
                                The mobile website only supports max 10 codes at a time, run the page on your computer to be able to decode 60 codes at a time.
                              </p>
                              </form>
              ...
              <div class="progress-bars animated" data-animation="fadeInRight" data-animation-delay="600">
                  <h2 class="main_title" id="main_title">Where to find equipment codes ?</h2>
                  <p class="skills-description" id="skills-description">In the case of VW, they can be found in the manual or under the boot lining next to the wheel.</p>
		...
		<div class="content footer">
            <div class="col-xs-12 align-center">
				...
				<p class="footer-text copyright animated" data-animation="fadeInUp" data-animation-delay="700">
					Copyright © <?php echo $year ?> - Scoobydowsky. All Rights Reserved.
